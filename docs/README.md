...
| [→ SD multiboot via a repaired preloader](boot-and-flash/sd-multiboot-apommel.md) | **Stock + SD distro at once** (method by [apommel](https://github.com/apommel/baseos-my355)): ROCKNIX / SpruceOS / MinUI base work; Knulli/GammaOS cards do not |

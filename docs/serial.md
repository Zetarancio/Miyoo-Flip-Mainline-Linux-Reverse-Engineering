...
Reference boot logs in this repo root: `boot_log_ROCKNIX.txt` (mainline), `boot_log_STOCK_INCLUDE_SLEEP_POWEROFF_AND_DEBUG.txt` (stock + debug), `boot_log_STOCK_INCLUDE_SLEEP_POWEROFF.txt` (stock).
